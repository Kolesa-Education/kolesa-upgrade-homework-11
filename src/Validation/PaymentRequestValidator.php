...
{
    public const INVALID_NAME = "name: Некорректные Имя и Фамилия";
    public const INVALID_CARD_NUMBER = "cardNumber: Должны быть 16 цифр";
    public const INVALID_CVV = "cvv: Должно быть 3-значное число";
    public const INVALID_EXPIRATION = "expiration: Некорректная дата";
